...
public enum PlayerCharacter {
   ...
   // PIRATE(5, 6, 3, 1, 3, 4, 8,
    ...
    PlayerCharacter(int spriteA_IDLE, int spriteA_RUNNING, int spriteA_JUMP, int spriteA_FALLING, int spriteA_ATTACK, int spriteA_HIT, int spriteA_DEAD,
        ...
        this.rowA = rowA;
        this.colA = colA;
        this.spriteW = spriteW * 2;
        this.spriteH = spriteH * 2;

        this.hitboxW = hitboxW * 2;
        this.hitboxH = hitboxH * 2;

        this.xDrawOffset = (int) (xDrawOffset * Game.SCALE * 2);
        this.yDrawOffset = (int) (yDrawOffset * Game.SCALE * 2);
    }
